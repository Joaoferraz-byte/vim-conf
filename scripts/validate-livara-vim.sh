...
require 'vim\.o\.winbar = ""' "$ui"
require 'laststatus = 3' "$repo_root/config/options.nix"
require 'fileinfo_component' "$ui"
require 'filetype_component' "$ui"
require 'scrollbar_component' "$ui"
require 'LivaraStatusText' "$ui"
...
forbidden '|' "$ui"
forbidden 'LivaraStatusMode|LivaraStatusGitSep|LivaraStatusLocationSep' "$ui"
