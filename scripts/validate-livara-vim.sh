...
require 'disabled_filetypes = \{' "$statusline"
...
require 'filetype_component' "$statusline"
...
require 'LivaraStatusline\.render' "$statusline"
require 'LivaraWinbar\.render' "$statusline"
...
require 'vim\.o\.winbar = "%!v:lua\.LivaraWinbar\.render\(\)"' "$statusline"
require 'laststatus = 3' "$repo_root/config/options.nix"
require 'fileinfo_component' "$statusline"
require 'filetype_component' "$statusline"
require 'scrollbar_component' "$statusline"
require 'LivaraStatusText' "$statusline"
require 'LivaraStatusGit' "$repo_root/config/theme.nix"
require 'LivaraStatusLocation' "$repo_root/config/theme.nix"
require 'location_component' "$statusline"
require 'git_component' "$statusline"
require 'return left .. "%=" .. right' "$statusline"
require 'mode_component' "$statusline"
require 'breadcrumb' "$statusline"
